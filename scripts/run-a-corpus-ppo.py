...
def main():
    ...
    from sts.train.apath import APathTrainer,fingerprint,check_deadline
    from sts.train.corpus_evaluation import evaluate,summarize,strata,paired_comparison
    from sts.models.apath import APathActorCritic
    ...
    writer=SummaryWriter(str(out/'tensorboard'/'a-v2-ppo-v1'),flush_secs=5)
